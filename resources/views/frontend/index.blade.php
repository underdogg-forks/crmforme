...
@section('content')
  <div class="row">
    ...
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="panel panel-default">
        <div class="panel-heading"><i
            class="fa fa-home"></i> {{ trans('strings.frontend.tests.js_injected_from_controller') }}</div>
    ...
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="panel panel-default">
        <div class="panel-heading"><i class="fa fa-home"></i> Bootstrap Glyphicon {{ trans('strings.frontend.test') }}
        </div>
