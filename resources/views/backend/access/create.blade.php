...
@section('content')
  ...
  <div class="box box-success">
    ...
    <div class="box-body">
      ...
      <div class="form-group">
        <label
          class="col-lg-2 control-label">{{ trans('validation.attributes.backend.access.users.send_confirmation_email') }}
          <br/>
        ...
        <div class="col-lg-3">
          @if (count($roles) > 0)
            @foreach($roles as $role)
              <input type="checkbox" value="{{ $role->id }}" name="assignees_roles[]" id="role-{{ $role->id }}"/> <label
