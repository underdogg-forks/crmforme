    ...
    'backend' => [
        'access' => [
            ...
            'users' => [
                ...
                'role_needed_create' => 'Du skal vælge mindst én rolle. Brugeren er blevet oprettet, men er deaktiveret.',
    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'resend' => 'Din konto er ikke bekræftet. Klik på linket i bekræftelsesmailen eller <a href="' . route('account.confirm.resend', ':user_id') . '">klik her</a> for at gensende bekræftelsesmailen.',
