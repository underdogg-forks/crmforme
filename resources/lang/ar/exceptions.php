    ...
    'backend' => [
        'access' => [
            ...
            'users' => [
                ...
                'role_needed_create' => 'يجب عليك إختيار دور واحد على الأقل للمستخدم، تم إنشاء المستخدم لكنه معطل.',
    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'resend' => 'حسابك غير مفعل. برجاء الضغط على رابط التفعيل الذي تم إرساله إلى بريدك الإلكتروني, أو <a href="' . route('account.confirm.resend', ':user_id') . '">إضغط هنا</a> لإعادة إرسال رابط التفعيل مجددا.',
